...
common_corruptions = OrderedDict([
    ...
    'model': lambda: timm.create_model("vit_base_patch16_224", pretrained=False, num_classes=10),
    'gdrive_id': '144ZT5jwmSGfDc1Ql4jKtsRPV--JtpV3W',
    }), 

    ('Standard_VITB_384', {
    # 'model': lambda: CustomPreprocessingWrapper(timm.create_model("vit_base_patch16_224", pretrained=False, num_classes=10)),
    'model': lambda: timm.create_model("vit_base_patch16_384", pretrained=True, num_classes=10),
    'gdrive_id': '',
    }), 
])
