...
common_corruptions = OrderedDict([
    ...
    ('Standard_VITB', {
    'model': lambda: timm.create_model("vit_base_patch16_224", pretrained=False, num_classes=100),
    'gdrive_id': '1FWSjdYB00L2dR-JiK0lKC0K25tdRxMev',
    }),

    ('Standard_VITB_384', {
    # 'model': lambda: CustomPreprocessingWrapper(timm.create_model("vit_base_patch16_224", pretrained=False, num_classes=10)),
    'model': lambda: timm.create_model("vit_base_patch16_384", pretrained=True, num_classes=100),
    'gdrive_id': '',
    }), 
])
